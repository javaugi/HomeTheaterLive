...
def check_ports():
    ...
    if port_in_use(8000):
        print("❌ Backend Port 8000 is already in use!")
        return False

    print("✅ Backend Port 8000 is available")
    return True
...
def main():
    print("Main function to run backend server")

    if not check_ports():
        print("\n⚠️  Please free up port 8000 before continuing.")
        sys.exit(1)
...
if __name__ == "__main__":
    print("Starting up Backend main ...")
    main()