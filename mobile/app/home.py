...
print(">>> importing mobile/app/home.py")
import toga
...
print(">>> importing mobile/app/home.py done")
...
class Home(toga.Box):
    ...
    def __init__(self, app):
        ...
        # Debug log
        print(f"#frontend/app/home.py Loading profile Home token: {self.access_token}")
    ...
    async def load_profile(self, widget=None):
        try:
            ...
            print(f"#frontend/app/home.py profile={profile}")
